...
cd /home/catkin_ws/src && git clone -b noetic-devel https://github.com/ros-industrial/universal_robot.git
rosdep update
cd /home/catkin_ws/
...
# remove opencv4
rm -r /usr/lib/x86_64-linux-gnu/cmake/opencv4/

# install opencv3
sudo apt-get install -y wget
cd /home/catkin_ws/src && wget https://github.com/opencv/opencv/archive/refs/tags/3.4.16.tar.gz
cd /home/catkin_ws/src && tar -zxvf 3.4.16.tar.gz
cd /home/catkin_ws/src/opencv-3.4.16 && mkdir build
cd /home/catkin_ws/src/opencv-3.4.16/build && cmake -D CMAKE_BUILD_TYPE=Release -D CMAKE_INSTALL_PREFIX=/usr/local .. && \
rm ../../3.4.16.tar.gz && make -j9 && sudo make install

echo 'export LD_LIBRARY_PATH=/usr/local/lib:$LD_LIBRARY_PATH' >> ~/.bashrc && source ~/.bashrc

# install ur5 package
cd /home/catkin_ws/src && git clone https://github.com/dairal/ur5-joint-position-control.git
#RUN cd /home/catkin_ws/src && git clone https://github.com/dairal/ur5-tcp-position-control.git
cd /home/catkin_ws/src && git clone https://github.com/filesmuggler/robotiq.git
cd /home/catkin_ws/src && git clone https://github.com/dairal/common-sensors
cd /home/catkin_ws/src && git clone https://github.com/dairal/opencv_services.git
cd /home/catkin_ws/src && git clone https://github.com/dairal/ur5_pick_and_place_opencv.git

# build catkin_ws
cd /home/catkin_ws && . /opt/ros/noetic/setup.sh && catkin_make
